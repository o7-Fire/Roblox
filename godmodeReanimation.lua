...
mouse.KeyDown:connect(function(Press)
	...
	if Press == 'j' then
		if dancing then
			...
			robuxpileweld.C0 = robuxpile.CFrame:inverse() * LeftArm.CFrame * CFrame.new(1, -.7, 1.5)
			...
			coroutine.wrap(function()
				coroutine.wrap(function()
					while wait(.085) do
						...
						robux.CFrame = robuxpile.CFrame * CFrame.Angles(math.rad(0), math.rad(0), math.rad(0))
						...
						robux.CFrame = CFrame.new(robux.Position, mouse.Hit.p) * CFrame.Angles(math.rad(math.random(-5, 5)), math.rad(0), math.rad(math.random(-180, 180)))
						bov.velocity = robux.CFrame.lookVector * math.random(40, 100)
