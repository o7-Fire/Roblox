...
mouse.KeyDown:connect(function(k)
    ...
    if k == "z" then
        ...
        spawn(function()
            local message = Instance.new("Message", workspace)
            message.Text =
                "Fe Invisible Fling By Diemiers#4209 Modified by Cryptxzz#1839 Loaded (wait 11 seconds to load)"
            wait(11)
            message:Destroy()
        end)
        ...
        game:GetService('RunService').Stepped:connect(
            function()
                game.Players.LocalPlayer.Character.HumanoidRootPart.CanCollide =
                    false
            end)
        ...
        bambam.Location = game.Players.LocalPlayer.Character.HumanoidRootPart
                              .Position
        ...
        function Fly()
            ...
            repeat
                ...
                if ctrl.l + ctrl.r ~= 0 or ctrl.f + ctrl.b ~= 0 then
                    ...
                    local shifting = UserInputService:IsKeyDown(
