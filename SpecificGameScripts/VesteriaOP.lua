...
function dmg(v)
    ...
    ["camera-cframe"] = CFrame.new(-4.23738432, 82.7017441, -139.418304, 0.973817468, -0.12980631, 0.186627701, 0, 0.820949852, 0.571000278, -0.22733143, -0.556050062, 0.799455285),
    ...
    game:GetService("ReplicatedStorage").modules.network.replicateAbilityStateChangeByPlayer:FireServer(ohNumber1, ohBoolean2, ohTable3, ohString4)
    ...
    game:GetService("ReplicatedStorage").modules.network.playerRequest_damageEntity:FireServer(ohInstance1, ohVector32, ohString3, ohNumber4, ohString5, ohString6)
    game:GetService("ReplicatedStorage").modules.network.playerRequest_damageEntity:FireServer(ohInstance1, ohVector32, ohString3, ohNumber4, ohString5, ohString6)

    local ohNumber1 = id
    local ohString2 = "end"
    
    game:GetService("ReplicatedStorage").modules.network.replicateAbilityStateChangeByPlayer:FireServer(ohNumber1, ohString2)
...
coroutine.wrap(function()
    while wait() do 
        for i , v in pairs(game:GetService("Workspace").placeFolders.items:GetChildren()) do
            if v.ClassName ~= 'Model' and (v.Position-game.Players.LocalPlayer.Character.PrimaryPart.Position).magnitude < 5 or v.ClassName == 'Model' and (v.PrimaryPart.Position-game.Players.LocalPlayer.Character.PrimaryPart.Position).magnitude < 5 then
...
coroutine.wrap(function()
    while true do 
        ...
        game.Players.LocalPlayer.Character.PrimaryPart.mana.Value = game.Players.LocalPlayer.Character.PrimaryPart.maxMana.Value
    end
end)()
while wait() do
    attack()
