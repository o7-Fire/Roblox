...
spawn(function()
    ...
    while true do
        if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") then
            clonec.Humanoid.Jump = game.Players.LocalPlayer.Character.Humanoid
                                       .Jump

            local veco = workspace.Camera.CFrame:VectorToObjectSpace(
...
local bodyvelocity = Instance.new("BodyVelocity", game.Players.LocalPlayer
...
function coffset(x, y, z) return (head.CFrame * CFrame.new(x, y, z)).Position end
...
spawn(function()
    ...
    while true do
        ...
        if game.Players.LocalPlayer.Character.Humanoid.MoveDirection.Magnitude >
            ...
            if pos then leg1.Position = pos end
            ...
            if pos then leg2.Position = pos end
...
spawn(function()
    ...
    local posn = game.Players.LocalPlayer.Character.Head.Position +
                     Vector3.new(0, -2.5, 0)
        ...
        for i = 1, 5 do
            ...
            for i = 1, count do
                ...
                if i == 1 then
                    ...
                    local pos1 = segs[i].Position -
                                     (segs[i].CFrame.LookVector * (len / 2)) -- Calculating position that is on back of the part
                    ...
                    local seg = segs[i]
                    local pos1 = segs[i].Position -
                                     (segs[i].CFrame.LookVector * (len / 2))
...
spawn(function()
    ...
    repeat
        ...
        game.Players.LocalPlayer.Character["Right Arm"].CFrame =
            segments.seg1.CFrame * CFrame.Angles(math.rad(90), 0, 0)
