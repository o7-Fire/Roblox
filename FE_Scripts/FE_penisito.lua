...
local name = "Torso"
if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").RigType ==
    Enum.HumanoidRigType.R15 then name = "UpperTorso" end
...
for i, v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
    ...
    if v.Name ~= root.Name and v.Name ~= "Humanoid" and v.Name ~= "Left Arm" and
        v.Name ~= "Left Leg" and v.Name ~= "Right Leg" then
        ...
        spawn(function()
            ...
            while true do
                bp.Position = root.Position +
                                  Vector3.new(0, 1.8 + 1.8 + 1.8 - 0.3, 0)
                wait()
            end
