...
speedText.MouseButton1Click:Connect(function()
    NumberV.Value = speedBox.Text
...
go.MouseButton1Click:Connect(function()
   ...
   while wait(NumberV.Value) do
    	...
    	if char:FindFirstChild("HumanoidRootPart") then
    	   Anim:Play()
           Anim:AdjustSpeed(1)
    	    char.HumanoidRootPart.CFrame = victimHump.HumanoidRootPart.CFrame - hump.CFrame.lookVector - hump.CFrame.lookVector
 
 
    		wait(NumberV.Value)
 
 
    		char.HumanoidRootPart.CFrame = hump.CFrame + hump.CFrame.lookVector*.15 + hump.CFrame.lookVector*.15 + hump.CFrame.lookVector*.15
 
    		wait(NumberV.Value)
 
            char.HumanoidRootPart.CFrame = hump.CFrame + hump.CFrame.lookVector*.3 + hump.CFrame.lookVector*.3 + hump.CFrame.lookVector*.3    		--char.HumanoidRootPart.CFrame = victimHump.HumanoidRootPart.CFrame - hump.CFrame.lookVector - hump.CFrame.lookVector
