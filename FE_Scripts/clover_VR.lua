...
--  | tysm unverified
--  | tutorial and info: https://pastebin.com/raw/UKAig7aU
    ...
    if RagdollEnabled then
        if script:FindFirstChild("Network") then
            ...
            Network = loadstring(game:HttpGet(
                                     "https://pastebin.com/raw/bJms9qqM", true))()
        end
        Network:Claim();
    end
...
--]]
    ...
    if not RagdollEnabled then
        Character.Humanoid.AnimationPlayed:Connect(
            function(Animation) Animation:Stop() end)
...
--]]
    ...
    local function GetGripForHandle(Handle)
        for _, Weld in next, Character:GetDescendants() do
            if Weld:IsA("Weld") and
                (Weld.Part0 == Handle or Weld.Part1 == Handle) then
                return Weld
            end
        end
    ...
    local function CreateAccessory(Accessory, DeleteMeshes)
        ...
        local HatAttachment = Accessory.Handle:FindFirstChildWhichIsA(
                                  "Attachment")
        local HeadAttachment = VirtualRig:FindFirstChild(HatAttachment.Name,
                                                         true)
    ...
    local function GetHeadAccessories()
        for _, Accessory in next, Character:GetChildren() do
            if Accessory:IsA("Accessory") and not UsedAccessories[Accessory] then
                ...
                table.insert(HeadAccessories,
                             {Handle, RightGrip, HatAtt, HeadAtt, BasePart})
...
--]]
    ...
    if not RagdollEnabled then
        LeftHandle, LeftHandGrip = CreateAccessory(
                                       Character:FindFirstChild(
                                           AccessorySettings.LeftArm),
                                       AccessorySettings.BlockArms)
        RightHandle, RightHandGrip = CreateAccessory(
                                         Character:FindFirstChild(
                                             AccessorySettings.RightArm),
                                         AccessorySettings.BlockArms)
        LeftHipHandle, LeftLegGrip = CreateAccessory(
                                         Character:FindFirstChild(
                                             AccessorySettings.LeftLeg),
                                         AccessorySettings.BlockLegs)
        RightHipHandle, RightLegGrip = CreateAccessory(
                                           Character:FindFirstChild(
                                               AccessorySettings.RightLeg),
                                           AccessorySettings.BlockLegs)
        TorsoHandle, TorsoGrip = CreateAccessory(
                                     Character:FindFirstChild(
                                         AccessorySettings.Torso),
        ...
        if RagdollHeadMovement then
            for _, Accessory in next, Character:GetChildren() do
                if Accessory:IsA("Accessory") and
                    ...
                    local Attachment1 = Accessory.Handle:FindFirstChildWhichIsA(
                                            "Attachment")
                    local Attachment0 = Character:FindFirstChild(
                                            tostring(Attachment1), true)
...
--]]
    ...
    local OnMoving = RunService.Stepped:Connect(
                         function()
            ...
            local Gyro =
                VirtualBody.HumanoidRootPart:FindFirstChild("BodyGyro") or
                    Instance.new("BodyGyro", VirtualBody.HumanoidRootPart)
    ...
    UserInputService.JumpRequest:Connect(
        function() VirtualBody.Humanoid.Jump = true end)
...
--]]
    ...
    if RagdollEnabled then
        for _, Part in pairs(Character:GetDescendants()) do
            ...
            if not Part:IsA("BasePart") and not Part:IsA("AlignPosition") and
                not Part:IsA("AlignOrientation") then
    ...
    local function FloorRay(Part, Distance)
        ...
        local FloorPart, FloorPosition, FloorNormal =
            workspace:FindPartOnRayWithIgnoreList(Line, {
                VirtualRig, VirtualBody, Character
            })
    ...
    local function FootYield()
        ...
        repeat
            ...
            if math.abs(LowerTorso.Position.Y - RightFooting.Position.Y) > 4 or
                math.abs(LowerTorso.Position.Y - LeftFooting.Position.Y) > 4 or
                ((UpperTorso.Position - RightFooting.Position) *
                    Vector3.new(1, 0, 1)).Magnitude >
                VirtualBody.Humanoid.WalkSpeed / 2.5 or
                ((UpperTorso.Position - LeftFooting.Position) *
                    Vector3.new(1, 0, 1)).Magnitude >
                VirtualBody.Humanoid.WalkSpeed / 2.5 then break end
    ...
    local function UpdateFooting()
        ...
        local MoveDirection = ((Pointer.Target.WorldPosition -
                                  VirtualRig.LowerTorso.Position) *
        ...
        local FootTarget = VirtualRig.LowerTorso.CFrame *
                               ...
                               Vector3.new(0, Dist, 0) + MoveDirection *
                               (VirtualBody.Humanoid.WalkSpeed / 4.2)
    ...
    local function UpdateTorsoPosition()
        if not RagdollEnabled then
            if TorsoHandle then
                ...
                TorsoGrip.C0 = TorsoGrip.C0:Lerp(
                                   WeldBase.CFrame:ToObjectSpace(
                                       Positioning * CFrame.new(0, -0.25, 0) *
    ...
    local function UpdateLegPosition()
        if not RagdollEnabled then
            if RightHipHandle then
                local Positioning = VirtualRig.RightLowerLeg.CFrame:Lerp(
                                        VirtualRig.RightFoot.CFrame, 0.5) +
                                        Vector3.new(0, 0.5, 0)
                ...
                RightLegGrip.C0 = RightLegGrip.C0:Lerp(
                                      WeldBase.CFrame:ToObjectSpace(
                                          Positioning *
                                              AccessorySettings.LimbOffset),
                                      Smoothness)
            ...
            if LeftHipHandle then
                local Positioning = VirtualRig.LeftLowerLeg.CFrame:Lerp(
                                        VirtualRig.LeftFoot.CFrame, 0.5) +
                                        Vector3.new(0, 0.5, 0)
                ...
                LeftLegGrip.C0 = LeftLegGrip.C0:Lerp(
                                     WeldBase.CFrame:ToObjectSpace(
                                         Positioning *
                                             AccessorySettings.LimbOffset),
                                     Smoothness)
    ...
    local function OnUserCFrameChanged(UserCFrame, Positioning, IgnoreTorso)
        ...
        if ((VRReady and UserCFrame == Enum.UserCFrame.Head) or not VRReady) and
            not IgnoreTorso then
            UpdateTorsoPosition()
            UpdateLegPosition()
        end
        ...
        if not RagdollEnabled then
            if UserCFrame == Enum.UserCFrame.Head and AccessorySettings.Head then
                for _, Table in next, HeadAccessories do
                    ...
                    RightGrip.C1 = HatAtt
                    RightGrip.C0 = RightGrip.C0:Lerp(
                                       WeldBase.CFrame:ToObjectSpace(
                                           LocalPositioning), Smoothness)
            ...
            elseif RightHandle and UserCFrame == Enum.UserCFrame.RightHand and
                ...
                if not VRReady then
                    ...
                    HandPosition = VirtualRig.RightUpperArm.CFrame:Lerp(
                                       VirtualRig.RightLowerArm.CFrame, 0.5) *
                                       AccessorySettings.LimbOffset
                ...
                RightHandGrip.C0 = RightHandGrip.C0:Lerp(
                                       WeldBase.CFrame:ToObjectSpace(
                                           HandPosition), Smoothness)
                ...
                if EquippedTool and EquippedTool:FindFirstChild("Handle") then
                    ...
                    EquippedGrip.C0 = EquippedGrip.C0:Lerp(
                                          ArmBaseCFrame:ToObjectSpace(
                                              LocalPositioning), Smoothness)
            ...
            elseif LeftHandle and UserCFrame == Enum.UserCFrame.LeftHand and
                ...
                if not VRReady then
                    HandPosition = VirtualRig.LeftUpperArm.CFrame:Lerp(
                                       VirtualRig.LeftLowerArm.CFrame, 0.5) *
                                       AccessorySettings.LimbOffset
                ...
                LeftHandGrip.C0 = LeftHandGrip.C0:Lerp(
                                      WeldBase.CFrame:ToObjectSpace(HandPosition),
                                      Smoothness)
        ...
        if RagdollEnabled then
            ...
            elseif UserCFrame == Enum.UserCFrame.RightHand then
                ...
                if not VRReady then
                    Positioning = VirtualRig.RightUpperArm.CFrame:Lerp(
                                      VirtualRig.RightLowerArm.CFrame, 0.5)
            ...
            elseif UserCFrame == Enum.UserCFrame.LeftHand then
                ...
                if not VRReady then
                    Positioning = VirtualRig.LeftUpperArm.CFrame:Lerp(
                                      VirtualRig.LeftLowerArm.CFrame, 0.5)
                elseif AccurateHandPosition then
                    Positioning = Positioning * CFrame.new(0, 0, 1)
                end
    ...
    local CFrameChanged = VRService.UserCFrameChanged:Connect(
                              OnUserCFrameChanged)

    local OnStepped = RunService.Stepped:Connect(
                          function()
    ...
    local OnRenderStepped = RunService.Stepped:Connect(
                                function()
            Camera.CameraSubject = VirtualBody.Humanoid
            ...
            if not VRReady then
                ...
                OnUserCFrameChanged(Enum.UserCFrame.LeftHand,
                                    CFrame.new(0, 0, 0), true)
            end
        end)
...
--]]
    ...
    local OnInput = UserInputService.InputBegan:Connect(
            ...
            if not Processed then
                ...
                if Input.KeyCode == Enum.KeyCode.C or Input.KeyCode ==
            ...
            if not VRReady and Input.UserInputType ==
                Enum.UserInputType.MouseButton1 then Point1 = true end

            if not VRReady and Input.UserInputType ==
                Enum.UserInputType.MouseButton2 then Point2 = true end
    ...
    local OnInputEnded = UserInputService.InputEnded:Connect(
                             function(Input, Processed)
            if not Processed then
                if Input.KeyCode == Enum.KeyCode.LeftControl or Input.KeyCode ==
                    Enum.KeyCode.ButtonL2 then
                ...
                elseif Input.KeyCode == Enum.KeyCode.ButtonB or Input.KeyCode ==
                    Enum.KeyCode.C then
                    if Mouse.Target and
                        (Mouse.Hit.p - Camera.CFrame.p).Magnitude < 1000 then
                        VirtualBody:MoveTo(Pointer.Target.WorldCFrame.p)
                        VirtualRig:SetPrimaryPartCFrame(
                            Pointer.Target.WorldCFrame)
                        VirtualRig.RightFoot.BodyPosition.Position =
                            Pointer.Target.WorldCFrame.p
                        VirtualRig.LeftFoot.BodyPosition.Position =
                            Pointer.Target.WorldCFrame.p
                    end
            ...
            if not VRReady and Input.UserInputType ==
                Enum.UserInputType.MouseButton1 then Point1 = false end

            if not VRReady and Input.UserInputType ==
                Enum.UserInputType.MouseButton2 then Point2 = false end
        end)
...
--]]
    ...
    OnReset = Client.CharacterAdded:Connect(
                  function()
            OnReset:Disconnect();
            ...
            if RagdollEnabled then Network:Unclaim(); end
	...
	--]]
        ...
        if VRReady or true then
            ...
            local Input = UserInputService.InputBegan:Connect(
                              function(Input) end)
            ...
            CharacterAdded = Client.CharacterAdded:Connect(
                                 function()
...
ChatHUDFunc = function()
    ...
    if VRReady then
        ...
        local RenderStepped = RunService.RenderStepped:Connect(
                                  function()
                local LeftHand = VRService:GetUserCFrame(
...
ViewHUDFunc = function()
    ...
    local function OnPlayerAdded(Player)
        ...
        local function CharacterAdded(Character)
            ...
            local TrueRoot = Character:FindFirstChild("HumanoidRootPart") or
            ...
            for i = 1, #Descendants do
                ...
                local Real = Part:IsA("BasePart") and
                                 GetPart(Part.Name, Part.Parent.Name,
                                         RealDescendants)
            ...
            RenderConnection = RunService.RenderStepped:Connect(
                    ...
                    if (TrueRoot and
                        (TrueRoot.Position - Camera.CFrame.p).Magnitude <=
                        ViewportRange) or Player == Client or not TrueRoot then
        ...
        if Player.Character then
            spawn(function() CharacterAdded(Player.Character) end)
        end
    end
