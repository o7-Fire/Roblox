...
game.Players.LocalPlayer.Character:MoveTo(Vector3.new(-3526.24243, 64.1496964, 533.052063))
end)
...
BackToMainBase.MouseButton1Click:connect(function()
game.Players.LocalPlayer.Character:MoveTo(Vector3.new(3571, 176.5745, 1153.81))
end)
